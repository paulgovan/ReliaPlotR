# Contributing to WeibullR.plotly

This outlines how to propose a change to WeibullR.plotly. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("paulgovan/WeibullR.plotly", fork = TRUE)`.
...
[Contributor Code of
Conduct](https://paulgovan.github.io/ReliaPlotR/CODE_OF_CONDUCT.md). By
