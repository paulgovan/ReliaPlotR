...
#'
#' Starts a Model Context Protocol (MCP) server that exposes two reliability
#' analysis tools -- `fit_weibull` and `fit_alt` -- to MCP clients such as
...
reliapltr_mcp_server <- function(...) {
  .check_mcp_deps()
  tools <- list(.make_wblr_tool(), .make_alt_tool())
